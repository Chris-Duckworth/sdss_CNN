...
def plot_regression(y_test, y_predicted, ax=None):
    '''
    ...
    ax.hlines(bin_means, bin_edges[:-1], bin_edges[1:], color='dodgerblue', lw=linewidth)
    ax.errorbar(bin_centers, bin_means, yerr=bin_std, color='dodgerblue', lw=linewidth)
